...
def gameLoop():
    ...
    while True:
        ...
        # Changing the score
        playerCenter = playerX + GAME_IMAGES["player"].get_width()/2
        for pipe in upperPipes:
            pipeCenter = pipe["x"] + GAME_IMAGES["pipe"][0].get_width()/2
            if pipeCenter <= playerCenter < pipeCenter + abs(pipeSpeedX):
                score = score + 1
        ...
        # Adding new pipes
        if 0 < upperPipes[0]["x"] < abs(pipeSpeedX)+1:
...
while True:
    # print("="*100)
    # print("#"+ " "*98 + "#")
    # print("#"+ "Select difficulty level".center(98, " ") + "#")
    # print("#"+ " "*98 + "#")
    # print("="*100)
    # print("Press 1 for Easy")
    # print("Press 2 for Medium")
    # print("Press 3 for Tough")
